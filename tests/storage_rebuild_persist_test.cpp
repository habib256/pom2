...
int main()
{
    ...
    // (The host-folder guard on the COMMAND path — `mountBlockBytes` /
    // `setMediaBayWriteBack` leave `hdv_path` alone — moved to
    // storage_coordinator, which links the controller those commands need.
    // This file tests the pure half only: TODO G5-4.)
